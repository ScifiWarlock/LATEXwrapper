...
def create(name):
    ...
    global tex_name
    tex_name = name
    fl = open("/Users/omkar/Desktop/LATEXwrapper/Multi_13/13_6/{file_name}.tex".format(file_name = name), 'a')

def clear():
    with open(f"/Users/omkar/Desktop/LATEXwrapper/Multi_13/13_6/{tex_name}.tex", "w") as k:
        pass 
...
def compile():
    subprocess.run(["open", "-a", "TeXShop", f"/Users/omkar/Desktop/LATEXwrapper/Multi_13/13_6/{tex_name}.tex"])
