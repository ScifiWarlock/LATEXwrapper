...
ld.line("For F(x, y, z), if ;greek('nabla'); F(x, y, z) ;greek('dot'); r(t) where r(t) is the tangent vector", False)
...
ld.line("Given z^2 - 2x^2 - 2y^2 = 12, find a tangent plane at point (1, -1, 4)", False)
